...
export default function About() {
  const values = [
    ...
    },
    {
      ...
      title: '넓은 시야',
      desc: '여러 레이어를 다루며 서비스 흐름을 파악합니다.',
    },
    {
      icon: (
        <svg width="28" height="28" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
  ...
  return (
    <section id="about" className="py-24 md:py-32 bg-white dark:bg-neutral-900 transition-colors duration-300">
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          {/* Profile photo + intro text — two-column on md+ */}
          <div className="flex flex-col md:flex-row-reverse gap-8 md:gap-16 mb-10">
            {/* Profile photo */}
            <motion.div
            ...
            <div className="flex-1 md:flex md:flex-col md:justify-center">
              ...
              <h3 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-6 leading-tight transition-colors duration-300">
                <span className="block">기록하고 고민하며,</span>
                <span className="block mt-2">내일의 코드를 더 낫게 만듭니다.</span>
              </h3>
